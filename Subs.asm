...
; change - A
GetAddrScr              ld    a, (VirtualScreenOnOFF)
                        ld    b, a
                        ld    a, e
                        ld    c, e
                        rrca
...
; out : nothing
; change : a, bc, de, hl
ClearMemoryBlock        ld   (ClearMemoryBlock2 + 1), sp
                        ld   sp, hl
                        ld   d, a
                        ld   e, a
ClearMemoryBlock1       dup  16
                        push de
                        edup
                        djnz    ClearMemoryBlock1
ClearMemoryBlock2       ld      sp, 0
                        ret
;****************************************
...
ClearScreenLine2        ld      (de), a
                        ...
                        ld      de, 26 * 256 + 11
ClearScreenLine3        ld      hl, 0
                        call    PrintStringB
                        ld      hl, $5960 + 26 + 19
                        ld      b, 5
ClearScreenLine4        ld      (hl), 5
                        inc     l
